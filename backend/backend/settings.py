...
# Lee el .env si existe (útil en local)
...
# DEBUG: En producción (Railway) debería ser False, pero si estás depurando errores puedes dejarlo temporalmente en True
DEBUG = env.bool('DEBUG', default=False)

# ALLOWED_HOSTS: Dominios que pueden servir la app
ALLOWED_HOSTS = [
    'test-repository-production-b71d.up.railway.app', # Tu dominio de Railway
    'localhost',
    '127.0.0.1',
    '.railway.app' # Comodín para subdominios de Railway
]
...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # Recomendado para estáticos en Railway
...
# ============================================
# CORS & CSRF (CONFIGURACIÓN CRÍTICA)
# ============================================

# 1. CORS: Permite que estos dominios pidan recursos al backend
CORS_ALLOW_ALL_ORIGINS = False
CORS_ALLOWED_ORIGINS = [
    "https://test-repository-production-b71d.up.railway.app", # Tu Backend
...
# Permitir credenciales (Cookies) en CORS
...
# 2. CSRF: Orígenes de confianza para POST/PUT/DELETE
# IMPORTANTE: En Django 4+ con HTTPS, el propio dominio del backend debe estar aquí
...
# ¡CRÍTICO! Debe ser False para que el JS del frontend pueda leer el token
CSRF_COOKIE_HTTPONLY = False 

# SameSite: 'Lax' suele funcionar bien si frontend y backend no están en dominios totalmente diferentes
# Si sigue fallando en local vs prod, prueba cambiar a 'None' (requiere Secure=True)
...
# ============================================
# SEGURIDAD HTTPS (PROXY FIX)
# ============================================

# IMPORTANTE: Esto le dice a Django que confíe en que Railway (Nginx) ya manejó el HTTPS
# Sin esto, Django cree que la conexión es insegura y bloquea las cookies Secure.
...
SESSION_COOKIE_HTTPONLY = True # La cookie de sesión SÍ debe ser HttpOnly
...
# CSP (Mantenemos tu configuración original, solo asegurando que funcione)
